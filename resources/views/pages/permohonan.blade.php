        ...
        <div class="container-fluid py-1 px-3">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
                    ...
                    <li class="breadcrumb-item text-sm text-dark active" aria-current="page">Permohonan</li>
                </ol>
                <h6 class="font-weight-bolder mb-0">Permohonan</h6>
            </nav>
        ...
        <div class="row">
            <div class="col-xl-8 p-3">
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="chart">
                            <div class="amchart" id="chartdivpermohonan1"></div>
                        </div>
                    </div>
                </div>
            </div>
            <div class="col-xl-4 p-3">
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="chart">
                            <div class="amchart" id="chartdivpermohonan2"></div>
                        </div>
                    </div>
                </div>
            </div>
...
<script>
    am4core.ready(function() {
        ...
        var chart = am4core.create("chartdivpermohonan1", am4charts.XYChart);
    ...
    am4core.ready(function() {
        ...
        // Create chart instance
        var chart = am4core.create("chartdivpermohonan2", am4charts.PieChart);
